   ...
   <body>
      ...
      <p>
        ...
        <?php
          ...
          // pero esta vez usando la función "empty" que devuelve
          // true si es "vacia" y false si no lo es
          // Como queremos comprobar que NO esté vacia
          // usamos el operador ! que niega la función
          // conviertiendola en "no vacia"
